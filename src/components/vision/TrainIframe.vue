...
export default {
    ...
    mounted(){
        this.$el.lastElementChild.firstElementChild.src = `${this.$resourceUrl}/shigongnengjiance-shili/index.html`;
...
<template>
    <div class="TrainIframe" v-loading.fullscreen.lock="!finished" element-loading-background="rgba(0, 0, 0, 0.3)">
        <div class="container" >
